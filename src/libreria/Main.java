...
public class Main {
	...
	public static void main(String[] args) {
		...
		Libro libro = new Libro("", 0, libreria);
		Cliente cliente = new Cliente("", "", "", 0, 0, null);
		Admin admin = new Admin("", "", libreria);
		
		String[] menuUsuario = { "Cliente", "Admin", "Salir" };
		String[] menuCliente = { "Seleccionar libro", "Finalizar compra", "Ver datos", "Salir" };
		String[] menuAdmin = { "Registrar estadísticas", "Calcular total facturado", "Ver datos", "Salir" };
